...
use crate::{lib_get_mut_slice, lib_get_slice, PackingResult};
...
impl<T, B> Debug for Integer<T, B>
where
    T: Debug,
{
...
impl<T, B> Display for Integer<T, B>
where
    T: Display,
{
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
mod serialize {
    ...
    impl<T, B> Serialize for super::Integer<T, B>
    where
        T: Serialize,
    {
    ...
    impl<'de, T, B> Deserialize<'de> for super::Integer<T, B>
    where
        T: Deserialize<'de>,
        T: Into<super::Integer<T, B>>,
    {
...
impl<T, B> PartialEq for Integer<T, B>
where
    T: PartialEq,
{
...
macro_rules! from_bytes {
    ...
    (2, $v: expr, $T: ident) => {
        (($v[0] as $T) << 8) | (($v[1] as $T) << 0)
    };
    (4, $v: expr, $T: ident) => {
        (($v[0] as $T) << 24) | (($v[1] as $T) << 16) | (($v[2] as $T) << 8) | (($v[3] as $T) << 0)
    };
    (8, $v: expr, $T: ident) => {
        (($v[0] as $T) << 56)
            | (($v[1] as $T) << 48)
...
integer_as_bytes!(u128, 16);
integer_as_bytes!(i128, 16);
...
macro_rules! bytes9_impl {
    ($T: ident, $IS_SIGNED: tt) => {
        integer_bytes_impl!($T, Bits65; $IS_SIGNED);
        integer_bytes_impl!($T, Bits66; $IS_SIGNED);
        integer_bytes_impl!($T, Bits67; $IS_SIGNED);
        integer_bytes_impl!($T, Bits68; $IS_SIGNED);
        integer_bytes_impl!($T, Bits69; $IS_SIGNED);
        integer_bytes_impl!($T, Bits70; $IS_SIGNED);
        integer_bytes_impl!($T, Bits71; $IS_SIGNED);
        integer_bytes_impl!($T, Bits72; $IS_SIGNED);
    };
}

macro_rules! bytes10_impl {
    ($T: ident, $IS_SIGNED: tt) => {
        integer_bytes_impl!($T, Bits73; $IS_SIGNED);
        integer_bytes_impl!($T, Bits74; $IS_SIGNED);
        integer_bytes_impl!($T, Bits75; $IS_SIGNED);
        integer_bytes_impl!($T, Bits76; $IS_SIGNED);
        integer_bytes_impl!($T, Bits77; $IS_SIGNED);
        integer_bytes_impl!($T, Bits78; $IS_SIGNED);
        integer_bytes_impl!($T, Bits79; $IS_SIGNED);
        integer_bytes_impl!($T, Bits80; $IS_SIGNED);
    };
}
macro_rules! bytes11_impl {
    ($T: ident, $IS_SIGNED: tt) => {
        integer_bytes_impl!($T, Bits81; $IS_SIGNED);
        integer_bytes_impl!($T, Bits82; $IS_SIGNED);
        integer_bytes_impl!($T, Bits83; $IS_SIGNED);
        integer_bytes_impl!($T, Bits84; $IS_SIGNED);
        integer_bytes_impl!($T, Bits85; $IS_SIGNED);
        integer_bytes_impl!($T, Bits86; $IS_SIGNED);
        integer_bytes_impl!($T, Bits87; $IS_SIGNED);
        integer_bytes_impl!($T, Bits88; $IS_SIGNED);
    };
}
macro_rules! bytes12_impl {
    ($T: ident, $IS_SIGNED: tt) => {
        integer_bytes_impl!($T, Bits89; $IS_SIGNED);
        integer_bytes_impl!($T, Bits90; $IS_SIGNED);
        integer_bytes_impl!($T, Bits91; $IS_SIGNED);
        integer_bytes_impl!($T, Bits92; $IS_SIGNED);
        integer_bytes_impl!($T, Bits93; $IS_SIGNED);
        integer_bytes_impl!($T, Bits94; $IS_SIGNED);
        integer_bytes_impl!($T, Bits95; $IS_SIGNED);
        integer_bytes_impl!($T, Bits96; $IS_SIGNED);
    };
}

macro_rules! bytes13_impl {
    ($T: ident, $IS_SIGNED: tt) => {
        integer_bytes_impl!($T, Bits97; $IS_SIGNED);
        integer_bytes_impl!($T, Bits98; $IS_SIGNED);
        integer_bytes_impl!($T, Bits99; $IS_SIGNED);
        integer_bytes_impl!($T, Bits100; $IS_SIGNED);
        integer_bytes_impl!($T, Bits101; $IS_SIGNED);
        integer_bytes_impl!($T, Bits102; $IS_SIGNED);
        integer_bytes_impl!($T, Bits103; $IS_SIGNED);
        integer_bytes_impl!($T, Bits104; $IS_SIGNED);
    };
}

macro_rules! bytes14_impl {
    ($T: ident, $IS_SIGNED: tt) => {
        integer_bytes_impl!($T, Bits105; $IS_SIGNED);
        integer_bytes_impl!($T, Bits106; $IS_SIGNED);
        integer_bytes_impl!($T, Bits107; $IS_SIGNED);
        integer_bytes_impl!($T, Bits108; $IS_SIGNED);
        integer_bytes_impl!($T, Bits109; $IS_SIGNED);
        integer_bytes_impl!($T, Bits110; $IS_SIGNED);
        integer_bytes_impl!($T, Bits111; $IS_SIGNED);
        integer_bytes_impl!($T, Bits112; $IS_SIGNED);
    };
}
macro_rules! bytes15_impl {
    ($T: ident, $IS_SIGNED: tt) => {
        integer_bytes_impl!($T, Bits113; $IS_SIGNED);
        integer_bytes_impl!($T, Bits114; $IS_SIGNED);
        integer_bytes_impl!($T, Bits115; $IS_SIGNED);
        integer_bytes_impl!($T, Bits116; $IS_SIGNED);
        integer_bytes_impl!($T, Bits117; $IS_SIGNED);
        integer_bytes_impl!($T, Bits118; $IS_SIGNED);
        integer_bytes_impl!($T, Bits119; $IS_SIGNED);
        integer_bytes_impl!($T, Bits120; $IS_SIGNED);
    };
}
macro_rules! bytes16_impl {
    ($T: ident, $IS_SIGNED: tt) => {
        integer_bytes_impl!($T, Bits121; $IS_SIGNED);
        integer_bytes_impl!($T, Bits122; $IS_SIGNED);
        integer_bytes_impl!($T, Bits123; $IS_SIGNED);
        integer_bytes_impl!($T, Bits124; $IS_SIGNED);
        integer_bytes_impl!($T, Bits125; $IS_SIGNED);
        integer_bytes_impl!($T, Bits126; $IS_SIGNED);
        integer_bytes_impl!($T, Bits127; $IS_SIGNED);
        integer_bytes_impl!($T, Bits128; $IS_SIGNED);
    };
}
...
bytes9_impl!(u128, unsigned);
bytes9_impl!(i128, signed);

bytes10_impl!(u128, unsigned);
bytes10_impl!(i128, signed);

bytes11_impl!(u128, unsigned);
bytes11_impl!(i128, signed);

bytes12_impl!(u128, unsigned);
bytes12_impl!(i128, signed);

bytes13_impl!(u128, unsigned);
bytes13_impl!(i128, signed);

bytes14_impl!(u128, unsigned);
bytes14_impl!(i128, signed);

bytes15_impl!(u128, unsigned);
bytes15_impl!(i128, signed);

bytes16_impl!(u128, unsigned);
bytes16_impl!(i128, signed);
...
use super::packing::{PackedStruct, PackedStructInfo, PackingError};
...
impl<T, B, I> Debug for MsbInteger<T, B, I>
where
    I: Debug,
{
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
impl<T, B, I> Display for MsbInteger<T, B, I>
where
    I: Display,
{
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
impl<T, B, I> Debug for LsbInteger<T, B, I>
where
    I: Debug,
{
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
impl<T, B, I> Display for LsbInteger<T, B, I>
where
    I: Display,
{
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
#[test]
fn test_struct_info() {
    fn get_bits<P: PackedStructInfo>(_s: &P) -> usize {
        P::packed_bits()
    }
